      ...
      <div className="flex-1 p-8 bg-gray-100 min-h-screen lg:ml-64">
              ...
              {users.map((user) => (
                <tr key={user.email} className="text-center">
                  ...
                  <td className="border border-gray-300 p-2">
                    ...
                    <button onClick={() => handleDelete(user.email)} className="bg-red-500 text-white px-2 py-1 rounded">Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        {editingUser && (
          <form onSubmit={handleSubmit} className="mt-6">
            ...
            <button onClick={() => setEditingUser(null)} className="bg-gray-500 text-white px-4 py-2 rounded ml-2">Cancel</button>
          </form>
        )}
      </div>
    </div>
