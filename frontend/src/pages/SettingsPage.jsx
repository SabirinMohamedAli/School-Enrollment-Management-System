...
import { FaUserGraduate, FaUser, FaBook, FaChartBar, FaCog, FaSignOutAlt } from 'react-icons/fa';
    ...
    <div className="container mx-auto p-4">
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <h1 className="text-3xl font-bold mb-4 text-center text-orange-200">Settings</h1>
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md dark:bg-orange-500 dark:text-white">
            <div className="mb-4">
              <label className="block text-gray-700 dark:text-gray-200">Theme</label>
              <select
                name="theme"
            ...
            <div className="mb-4">
              <label className="block text-gray-700 dark:text-gray-200">Notifications</label>
              <input
                type="checkbox"
                name="notifications"
            ...
            <div className="mb-4">
              <label className="block text-gray-700 dark:text-gray-200">Language</label>
              <select
                name="language"
